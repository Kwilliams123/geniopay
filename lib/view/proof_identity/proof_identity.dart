...
class ProofIdentity extends StatelessWidget{
  ...
  const ProofIdentity({required this.tapLink, required this.tapArrowBack, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final additionalInformationText = Text('There may also be rare'
    ...
    final baseParent =  Container(
      ...
      child: SingleChildScrollView
        ...
        children: [
          ...
          descriptionRow('residence',
              'Proof of Residence Document Scan',
              'learn more'),
          const SizedBox(height: 30,),
          descriptionRow('video',
